...
import com.falabella.challenge.data.server.economicindicator.Bitcoin as BitcoinSchema
import com.falabella.challenge.data.server.economicindicator.EconomicIndicatorSchema
import com.falabella.challenge.data.server.economicindicator.Tasa_desempleo as TasaDesempleoSchema
import com.falabella.challenge.data.server.economicindicator.Libra_cobre as LibraCobreSchema
import com.falabella.challenge.data.server.economicindicator.Tpm as TpmSchema
import com.falabella.challenge.data.server.economicindicator.Imacec as ImacecSchema
import com.falabella.challenge.data.server.economicindicator.Utm as UtmSchema
import com.falabella.challenge.data.server.economicindicator.Ipc as IpcSchema
import com.falabella.challenge.data.server.economicindicator.Euro as EuroSchema
import com.falabella.challenge.data.server.economicindicator.Dolar_intercambio as DolarChangeSchema
import com.falabella.challenge.data.server.economicindicator.Dolar as DolarSchema
import com.falabella.challenge.data.server.economicindicator.Ivp as IvpSchema
import com.falabella.challenge.data.server.economicindicator.Uf as UfSchema
